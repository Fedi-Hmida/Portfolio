...
import nvidiaDliImg from "../../assets/images/news14/nvidea1.jpg";
...
const NewsNvidiaDLI = () => {
  ...
  const milestones = [
    ...
    "Working through practical accuracy challenges",
    "Strengthening applied model development fundamentals",
    "Preparing these skills for real-world AI projects",
  ];
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              ...
              <motion.div {...floatAnimation} className="relative z-10">
                ...
                <p className="text-lg md:text-xl leading-relaxed text-[#e3f2fd]/90">
                  Certified. I completed NVIDIA DLI - Fundamentals of Deep
                  Learning, a practical milestone covering model training,
                  fine-tuning, and real accuracy challenges.
                </p>
              </motion.div>
            </motion.div>
            ...
            >
              <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                <FaAward className="text-[#a8ff60]" /> Practical AI Milestone
              </h3>
              <p className="text-[#e3f2fd]/80 leading-relaxed mb-6">
                From training and fine-tuning models to solving real accuracy
                challenges, this certification strengthened my hands-on deep
                learning workflow and gave me another practical base to apply in
                AI projects.
              </p>
              <p className="text-[#e3f2fd]/80 leading-relaxed mb-8">
                Looking forward to applying these skills to real-world projects,
                especially where model quality, experimentation, and iteration
                matter.
              </p>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            >
              <div className="relative overflow-hidden rounded-[20px] group bg-white flex items-center justify-center">
                <ExpandableImage
                  src={nvidiaDliImg}
                  alt="NVIDIA DLI Fundamentals of Deep Learning certification"
                  loading="lazy"
                  decoding="async"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1a237e]/80 to-transparent flex items-end p-6 pointer-events-none">
                  <p className="text-white font-medium">NVIDIA DLI Certified</p>
                </div>
              </div>
            </motion.div>
